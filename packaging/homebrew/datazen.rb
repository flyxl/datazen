...
cask "datazen" do
  ...
  on_arm do
    ...
    url "https://github.com/flyxl/datazen/releases/download/v#{version}/DataZen-#{version}-macos-arm64.dmg"
  end
  on_intel do
    sha256 "f7d459322899ca3f03210211ec15bb883ad79bbc0f70172eab61494b51d05dee"
    url "https://github.com/flyxl/datazen/releases/download/v#{version}/DataZen-#{version}-macos-x64.dmg"
  end
