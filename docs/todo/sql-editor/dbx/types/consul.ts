...
export type ConsulCapabilityStatus =
  | 'supported'
  | 'unsupported'
  | 'disabled'
  | 'forbidden'
...
export type ConsulImportOperation =
  | 'create'
  | 'update'
  | 'unchanged'
  | 'skipped'
...
export type ConsulDomainWatchItems =
  | ConsulCatalogNode[]
  | Record<string, string[]>
  | ConsulCatalogServiceNode[]
  | ConsulNodeServices
  | ConsulHealthCheck[]
...
export type ConsulOperatorReadKind =
...
export type ConsulEnterpriseList =
  | { kind: 'namespace'; items: ConsulNamespace[] }
  | { kind: 'partition'; items: ConsulPartition[] };
export type ConsulEnterpriseItem =
  | { kind: 'namespace'; item: ConsulNamespace }
  | { kind: 'partition'; item: ConsulPartition };
