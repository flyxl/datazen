...
const multiDbDialogSource = readFileSync(
  resolve(process.cwd(), 'apps/desktop/src/components/editor/MultiDbExecuteDialog.vue'),
  'utf8',
);
const tagPanelSource = readFileSync(
  resolve(process.cwd(), 'apps/desktop/src/components/config/TagManagementPanel.vue'),
  'utf8',
);
