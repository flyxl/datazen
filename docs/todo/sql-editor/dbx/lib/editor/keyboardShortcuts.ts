...
export function eventToModifierOnlyShortcut(
  event: ShortcutLikeEvent,
  platform = globalThis.navigator?.platform || '',
): string | null {
  if (event.isComposing) return null;
...
export function matchesModifierOnlyShortcut(
  event: Omit<ShortcutLikeEvent, 'key'>,
  shortcut: string,
): boolean {
...
const SWITCH_TO_TAB_ACTIONS: ShortcutActionId[] = [
  'switchToTab1',
  'switchToTab2',
  'switchToTab3',
  'switchToTab4',
...
export function isExecuteSqlShortcut(
  event: ShortcutLikeEvent,
  shortcuts?: Partial<ShortcutSettings>,
): boolean {
...
export function isExecuteSqlInNewResultTabShortcut(
  event: ShortcutLikeEvent,
  shortcuts?: Partial<ShortcutSettings>,
): boolean {
...
export function isCloseOtherTabsShortcut(
  event: ShortcutLikeEvent,
  shortcuts?: Partial<ShortcutSettings>,
  platform = globalThis.navigator?.platform || '',
): boolean {
...
export function isSendSelectionToAiShortcut(
  event: ShortcutLikeEvent,
  shortcuts?: Partial<ShortcutSettings>,
): boolean {
...
export function isConvertNamingStyleShortcut(
  event: ShortcutLikeEvent,
  shortcuts?: Partial<ShortcutSettings>,
  platform = globalThis.navigator?.platform || '',
): boolean {
  return matchesShortcut(
    event,
    actionShortcut('convertNamingStyle', shortcuts, platform),
    platform,
  );
}

export function isNewQueryShortcut(
  event: ShortcutLikeEvent,
  shortcuts?: Partial<ShortcutSettings>,
): boolean {
...
export function isRefreshDataShortcut(
  event: ShortcutLikeEvent,
  shortcuts?: Partial<ShortcutSettings>,
): boolean {
...
export function isToggleResultsPaneShortcut(
  event: ShortcutLikeEvent,
  shortcuts?: Partial<ShortcutSettings>,
): boolean {
...
export function isZoomInShortcut(
  event: ShortcutLikeEvent,
  shortcuts?: Partial<ShortcutSettings>,
): boolean {
...
export function isZoomOutShortcut(
  event: ShortcutLikeEvent,
  shortcuts?: Partial<ShortcutSettings>,
): boolean {
...
export function isResetZoomShortcut(
  event: ShortcutLikeEvent,
  shortcuts?: Partial<ShortcutSettings>,
): boolean {
...
export function isToggleTransposeShortcut(
  event: ShortcutLikeEvent,
  shortcuts?: Partial<ShortcutSettings>,
): boolean {
...
export function isAcceptCompletionShortcut(
  event: ShortcutLikeEvent,
  shortcuts?: Partial<ShortcutSettings>,
): boolean {
...
export function isCopyCurrentRowShortcut(
  event: ShortcutLikeEvent,
  shortcuts?: Partial<ShortcutSettings>,
): boolean {
...
export function isEditTableStructureShortcut(
  event: ShortcutLikeEvent,
  shortcuts?: Partial<ShortcutSettings>,
  platform = globalThis.navigator?.platform || '',
): boolean {
  return matchesShortcut(
    event,
    actionShortcut('editTableStructure', shortcuts, platform),
    platform,
  );
}

export function isDeleteCurrentRowShortcut(
  event: ShortcutLikeEvent,
  shortcuts?: Partial<ShortcutSettings>,
): boolean {
...
export function isGoToColumnShortcut(
  event: ShortcutLikeEvent,
  shortcuts?: Partial<ShortcutSettings>,
  platform = globalThis.navigator?.platform || '',
): boolean {
...
export function isGoToFirstPageShortcut(
  event: ShortcutLikeEvent,
  shortcuts?: Partial<ShortcutSettings>,
): boolean {
...
export function isGoToPreviousPageShortcut(
  event: ShortcutLikeEvent,
  shortcuts?: Partial<ShortcutSettings>,
): boolean {
...
export function isGoToNextPageShortcut(
  event: ShortcutLikeEvent,
  shortcuts?: Partial<ShortcutSettings>,
): boolean {
...
export function isGoToLastPageShortcut(
  event: ShortcutLikeEvent,
  shortcuts?: Partial<ShortcutSettings>,
): boolean {
...
export function isCancelSearchShortcut(
  event: ShortcutLikeEvent,
  shortcuts?: Partial<ShortcutSettings>,
): boolean {
...
export function isToggleZenModeShortcut(
  event: ShortcutLikeEvent,
  shortcuts?: Partial<ShortcutSettings>,
): boolean {
...
export function isCopySidebarSelectionShortcut(
  event: ShortcutLikeEvent,
  shortcuts?: Partial<ShortcutSettings>,
): boolean {
...
export function isPasteSidebarSelectionShortcut(
  event: ShortcutLikeEvent,
  shortcuts?: Partial<ShortcutSettings>,
): boolean {
...
export function isEditSidebarConnectionShortcut(
  event: ShortcutLikeEvent,
  shortcuts?: Partial<ShortcutSettings>,
): boolean {
...
export function isViewTableDdlShortcut(
  event: ShortcutLikeEvent,
  shortcuts?: Partial<ShortcutSettings>,
): boolean {
...
export function isNavigateTabHistoryBackShortcut(
  event: ShortcutLikeEvent,
  shortcuts?: Partial<ShortcutSettings>,
  platform = globalThis.navigator?.platform || '',
): boolean {
  return matchesShortcut(
    event,
    actionShortcut('navigateTabHistoryBack', shortcuts, platform),
    platform,
  );
}

export function isNavigateTabHistoryForwardShortcut(
  event: ShortcutLikeEvent,
  shortcuts?: Partial<ShortcutSettings>,
  platform = globalThis.navigator?.platform || '',
): boolean {
  return matchesShortcut(
    event,
    actionShortcut('navigateTabHistoryForward', shortcuts, platform),
    platform,
  );
}

export function handleTabHistoryNavigationShortcut(
  event: ShortcutLikeEvent,
...
export function isSwitchToPreviousTabShortcut(
  event: ShortcutLikeEvent,
  shortcuts?: Partial<ShortcutSettings>,
): boolean {
...
export function isSwitchToNextTabShortcut(
  event: ShortcutLikeEvent,
  shortcuts?: Partial<ShortcutSettings>,
): boolean {
 ...
 */
export function tabSwitcherDirectionFromShortcut(
  event: ShortcutLikeEvent,
  shortcuts?: Partial<ShortcutSettings>,
  platform = globalThis.navigator?.platform || '',
): -1 | 1 | null {
  ...
  if (event.shiftKey && matchesShortcut({ ...event, shiftKey: false }, shortcut, platform))
    return -1;
  return null;
}

export function switchToTabIndexFromShortcut(
  event: ShortcutLikeEvent,
  shortcuts?: Partial<ShortcutSettings>,
): number | null {
  const normalized = normalizeShortcutSettings(shortcuts);
  const index = SWITCH_TO_TAB_ACTIONS.findIndex((actionId) =>
    matchesShortcut(event, normalized[actionId]),
  );
