...
import {
  trailingStatementDelimiterPosition,
  type StatementDelimiterDocument,
} from '@/lib/sql/statementDelimiter';

export function currentStatementFrameRangeTo(
  doc: StatementDelimiterDocument,
  range: SqlTextRange,
): number {
