...
export const SQL_VARIABLE_SYNTAX_KEYS = [
  'positional',
  'named',
  'shell',
  'mybatis',
  'sqlserver',
  'atSet',
] as const satisfies readonly (keyof SqlVariableSyntaxToggles)[];
...
const PARAMETER_SYNTAX_KEYS = [
  'positional',
  'named',
  'shell',
  'mybatis',
  'sqlserver',
] as const satisfies readonly SqlParameterSyntax[];

export type SqlVariableSyntaxOverrides = Partial<
  Record<DatabaseType, Partial<SqlVariableSyntaxToggles>>
>;
 ...
 * on every execution.
 */
export function resolveSqlVariableSyntaxToggles(
  overrides: SqlVariableSyntaxOverrides | undefined,
  dbType: DatabaseType | undefined,
  enabled = true,
): SqlVariableSyntaxToggles {
  if (!enabled) {
    return {
      positional: false,
      named: false,
...
export function enabledSqlParameterSyntaxes(
  toggles: SqlVariableSyntaxToggles,
): SqlParameterSyntax[] {
