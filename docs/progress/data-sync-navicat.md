...
|----|------|------|------|----------------|--------|--------|
| F1 | `data_sync` 领域模型 + 状态机 + ChangeSet 选择规则 | done | 30 PASS | [F1 QA](45f474d3-e7da-4c9a-b593-ce3d61ce5f80) PASS | 99.31% | 待提交 |
| F2 | 同族 pairing + 结构完全一致 + 相同 PK 硬门闸 | pending | — | — | — | — |
| F3 | 停用旧 DROP+INSERT `sync_tables` 产品路径 | pending | — | — | — | — |
