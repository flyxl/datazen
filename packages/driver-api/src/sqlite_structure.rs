//! Table structure editor capabilities and DDL planning for the SQLite dialect
//! family (SQLite, RQLite, Turso/libSQL).

use crate::*;

/// Static capability flags for SQLite-family drivers (additive ALTER + index ops).
