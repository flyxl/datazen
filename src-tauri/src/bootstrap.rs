//! Legacy `include_str!("../bootstrap.rs")` target for command-layer IPC
//! contract tests that still reference this path.
//!
//! The real module is loaded via `#[path = "bootstrap/mod.rs"]` in `lib.rs`.
//! This file is intentionally not the module root — do not add `mod` items here.
