...
//!
//! This module is intentionally independent from workflow persistence and
//! execution so the workflow engine can evolve without keeping all concerns in
//! one source file.
...
pub enum WorkflowStep {
    /// Legacy SQL query format. Kept for backwards-compatible YAML loading.
    #[serde(rename = "query")]
    Query {
        id: String,
        sql: String,
    ...
    /// Generic Driver command. New data-operation steps should use this form.
