...
#[allow(dead_code)]
pub type WappManifest = ExtensionManifest;
#[allow(dead_code)]
pub type WappContributions = Contributions;
#[allow(dead_code)]
pub type WappPageContribution = PageContribution;
#[allow(dead_code)]
pub type WappThemeContribution = ThemeContribution;
#[allow(dead_code)]
pub type WappPermission = Permission;
