...
const pack = {
  ...
  'newConn.httpProxyHint': 'Uses HTTP CONNECT through a corporate proxy. Prefer scheme=http when possible.',
  ...
  'newConn.wsHint': 'Connects via a WebSocket relay. datazen_v1 negotiates the target with open/opened frames; raw_binary pipes bytes immediately.',
