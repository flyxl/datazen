...
const pack = {
  ...
  'workspace.defaultHint':
    'Click an item in the left navigator or a card below to open an extension page.',
  'workspace.emptyTitle': 'No workspace extensions yet',
  'workspace.emptyHint': 'Install an extension from the Extensions page and it will show up here.',
  'workspace.openExtensions': 'Open Extensions',
  'workspace.shell.reload': 'Reload',
  'workspace.shell.loadFailed': 'Extension page failed to load.',
  'extensions.page.title': 'Extensions',
  'extensions.page.count': '{count} installed',
  'extensions.page.subtitle':
    'Manage installed extensions, install new packages, or browse themes.',
  'extensions.page.searchPlaceholder': 'Search extensions…',
  'extensions.page.filterAll': 'All ({count})',
  'extensions.page.filterWorkspace': 'Workspace ({count})',
  'extensions.page.filterTheme': 'Themes ({count})',
  'extensions.page.install': 'Install Extension…',
  'extensions.page.open': 'Open',
  'extensions.page.toggle': 'Enable extension',
  'extensions.page.uninstall': 'Uninstall extension',
  'extensions.page.uninstallTitle': 'Uninstall Extension',
  'extensions.page.uninstallMessage':
    'Remove "{name}" from DataZen? Its workspace tabs will be closed, and ALL data the extension saved locally (its storage) will be permanently deleted.',
  ...
  'extensions.install.description':
    'Select a local extension package (.zip) or unpacked folder to install.',
  'extensions.install.pickPrompt': 'Choose how to locate the extension package on this computer.',
  'extensions.install.browseZip': 'Select ZIP file…',
  'extensions.install.browseFolder': 'Select folder…',
  'extensions.install.back': 'Back',
  'extensions.install.inspecting': 'Checking…',
  'extensions.install.permissions': 'Requested permissions',
  'extensions.install.noPermissions': 'This package requests no permissions.',
  'extensions.page.groupWorkspace': 'Workspace pages',
  'extensions.page.groupTheme': 'Themes',
  'extensions.install.confirm': 'Install',
  'extensions.install.installing': 'Installing…',
