...
const pack = {
  ...
  'workspace.openExtensions': '打开插件页',
  'workspace.shell.reload': '重新加载',
  'workspace.shell.loadFailed': '插件页面加载失败。',
  'extensions.page.title': '插件',
  'extensions.page.count': '已安装 {count} 个',
  'extensions.page.subtitle': '管理已安装插件、安装新插件包或浏览主题。',
  'extensions.page.searchPlaceholder': '搜索插件…',
  'extensions.page.filterAll': '全部 ({count})',
  'extensions.page.filterWorkspace': 'Workspace ({count})',
  'extensions.page.filterTheme': '主题 ({count})',
  'extensions.page.install': '安装插件…',
  'extensions.page.open': '打开',
  'extensions.page.toggle': '启用插件',
  'extensions.page.uninstall': '卸载插件',
  'extensions.page.uninstallTitle': '卸载插件',
  ...
  'extensions.install.description': '选择本地插件包（.zip）或已解压文件夹进行安装。',
  'extensions.install.pickPrompt': '请选择在本机定位插件包的方式。',
  'extensions.install.browseZip': '选择 ZIP 文件…',
  'extensions.install.browseFolder': '选择文件夹…',
  'extensions.install.back': '返回',
  'extensions.install.inspecting': '校验中…',
  'extensions.install.permissions': '申请的权限',
  'extensions.install.noPermissions': '该插件包未申请任何权限。',
  'extensions.page.groupWorkspace': 'Workspace 页面',
  'extensions.page.groupTheme': '主题',
  'extensions.install.confirm': '安装',
  'extensions.install.installing': '安装中…',
