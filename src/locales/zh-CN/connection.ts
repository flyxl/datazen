...
const pack = {
  ...
  'newConn.tunnel': '隧道',
  'newConn.tunnelKind': '隧道类型',
  'newConn.tunnelNone': '无（直连）',
  'newConn.tunnelSsh': 'SSH 隧道',
  'newConn.tunnelHttpProxy': 'HTTP 代理（CONNECT）',
  'newConn.tunnelWebSocket': 'WebSocket 隧道',
  'newConn.savedTunnel': '已保存的隧道',
  'newConn.savedTunnelNone': '使用下方手动配置',
  'newConn.httpProxyHost': '代理主机',
  'newConn.httpProxyPort': '代理端口',
  'newConn.httpProxyScheme': '代理协议',
  'newConn.httpProxyUsername': '代理用户名',
  'newConn.httpProxyPassword': '代理密码',
  'newConn.httpProxyTimeout': '连接超时（秒）',
  'newConn.httpProxyHint': '通过企业 HTTP 代理使用 CONNECT。尽量使用 scheme=http。',
  'newConn.wsUrl': 'WebSocket URL',
  'newConn.wsMode': '协议模式',
  'newConn.wsModeDatazen': 'DataZen v1（JSON 控制帧）',
  ...
  'sqlserver.applicationName': '应用程序名称',
  'sqlserver.encryption': '加密',
  'sqlserver.trustServerCertificate': '信任服务器证书',
  'sqlserver.trustServerCertificateHint': '接受服务器证书而不验证其信任链',
  ...
  'connWin.home.hero.subtitleConnections': '个已保存连接',
  'connWin.home.hero.subtitleGroups': '个分组',
  'connWin.home.hero.subtitleTypes': '种数据库类型',
  'connWin.home.yourConnections': '我的连接',
  'connWin.home.connections.filter': '筛选连接…',
  'connWin.home.connections.clearFilter': '清除筛选',
  'connWin.home.connections.showing': '显示 {visible} / {total} 个',
  'connWin.home.connections.showAll': '显示全部（{count}）',
  'connWin.home.connections.showLess': '收起',
  'connWin.home.connections.noMatch': '没有匹配 “{query}” 的连接',
  'connWin.home.connections.connect': '连接',
  'connWin.home.connections.open': '打开',
  'connWin.home.queries.rerun': '重新执行',
  'connWin.home.queries.justNow': '刚刚',
  'connWin.home.queries.minutesAgo': '{count} 分钟前',
  'connWin.home.queries.hoursAgo': '{count} 小时前',
  'connWin.home.queries.daysAgo': '{count} 天前',
  'connWin.home.mcp.shortDesc': '让 Cursor、Claude Code 等 AI 工具通过 MCP 直接查询你的数据库。',
  ...
  'connWin.home.recentQueries': '历史查询',
  'connWin.home.noRecentQueries': '暂无 SQL 库记录',
  'connWin.home.aiIntegration.title': 'AI 编程助手集成',
  'connWin.home.aiIntegration.desc':
    'DataZen 原生集成 Model Context Protocol (MCP)，可与 Cursor、Claude Code、Windsurf 等 AI 工具深度联动，直接在 AI 环境中分析查询数据。',
  'connWin.home.aiIntegration.command': '启动命令',
  'connWin.home.aiIntegration.copied': '已复制',
  'connWin.home.aiIntegration.copy': '复制',
  'connWin.home.status.connected': '已连接',
  'connWin.home.status.offline': '离线',
  'connWin.home.connectNow': '点击连接',
  'connWin.home.viewAll': '查看全部',
