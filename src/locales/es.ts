const translations = {
  ...
  'sync.overwriteRetiredBanner': 'La copia por sobrescritura (DROP + INSERT) se ha retirado. La sincronización de datos compara filas y aplica un conjunto de cambios; Aplicar aún no está conectado.',
  ...
  'sync.mappingSummary': '{matched} emparejadas · {incompatible} incompatibles · {unmapped} sin mapear',
