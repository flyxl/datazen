const zhCN = {
  ...
  'skills.storageDir': '技能存储路径',
  'skills.storageDirHint': '将 YAML 文件放入此文件夹可自动加载',
  'skills.form.id': '技能 ID',
  'skills.form.idPlaceholder': '例如: my-skill（仅限英文、数字和连字符）',
  'skills.form.name': '技能名称',
  'skills.form.namePlaceholder': '给技能起一个名字',
  'skills.form.description': '描述',
  'skills.form.descriptionPlaceholder': '简要描述该技能的功能',
  'skills.form.steps': '步骤',
  'skills.form.addQueryStep': '+ 查询步骤',
  'skills.form.addAiStep': '+ AI 步骤',
  'skills.form.stepId': '步骤 ID',
  'skills.form.sql': 'SQL 语句',
  'skills.form.prompt': 'AI Prompt',
  'skills.form.removeStep': '移除',
  'skills.form.variables': '变量',
  'skills.form.addVariable': '+ 添加变量',
  'skills.form.varName': '变量名',
  'skills.form.varType': '类型',
  'skills.form.varDesc': '描述',
  'skills.form.varRequired': '必填',
  'skills.saved': '技能已保存',
  'skills.reload': '刷新',
  'skills.executionFailed': '执行失败',
  'skills.finalOutput': '最终输出',
  'skills.form.varTypeConnection': '连接',
  'skills.form.selectConnection': '选择连接…',
  'skills.form.connection': '连接',
  'skills.form.defaultConnection': '使用默认连接',
  'skills.form.addConditionStep': '+ 条件步骤',
  'skills.form.addForeachStep': '+ 循环步骤',
  'skills.form.condition': '条件',
  'skills.form.foreach': '循环',
  'skills.form.conditionHint': '子步骤需在 YAML 中编辑',
  'skills.history.title': '执行记录',
  'skills.history.empty': '暂无执行记录',
  'skills.history.back': '返回列表',
  'skills.history.clear': '清空记录',
  'skills.history.clearConfirm': '确定要清空所有执行记录吗？',
