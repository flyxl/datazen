const zhCN = {
  ...
  'sync.openSchemaDiff': '结构对比',
  'sync.openDataTransfer': '数据传输',
  ...
  'transfer.mode.structure': '仅结构',
  'transfer.mode.data': '仅数据',
