...
const en: Record<TranslationKey, string> = {
  ...
  'skills.empty': 'No skills defined.',
  'skills.run': 'Run',
  ...
  'skills.storageDir': 'Skill Storage Path',
  'skills.storageDirHint': 'Place YAML files in this folder to auto-load them',
  'skills.form.id': 'Skill ID',
  'skills.form.idPlaceholder': 'e.g. my-skill (letters, numbers, hyphens only)',
  'skills.form.name': 'Skill Name',
  'skills.form.namePlaceholder': 'Give your skill a name',
  'skills.form.description': 'Description',
  'skills.form.descriptionPlaceholder': 'Briefly describe what this skill does',
  'skills.form.steps': 'Steps',
  'skills.form.addQueryStep': '+ Query Step',
  'skills.form.addAiStep': '+ AI Step',
  'skills.form.stepId': 'Step ID',
  'skills.form.sql': 'SQL Statement',
  'skills.form.prompt': 'AI Prompt',
  'skills.form.removeStep': 'Remove',
  'skills.form.variables': 'Variables',
  'skills.form.addVariable': '+ Add Variable',
  'skills.form.varName': 'Variable Name',
  'skills.form.varType': 'Type',
  'skills.form.varDesc': 'Description',
  'skills.form.varRequired': 'Required',
  'skills.saved': 'Skill saved',
  'skills.reload': 'Reload',
  'skills.executionFailed': 'Execution failed',
  'skills.finalOutput': 'Final output',
  'skills.form.varTypeConnection': 'Connection',
  'skills.form.selectConnection': 'Select connection…',
  'skills.form.connection': 'Connection',
  'skills.form.defaultConnection': 'Use default connection',
  'skills.form.addConditionStep': '+ Condition step',
  'skills.form.addForeachStep': '+ ForEach step',
  'skills.form.condition': 'Condition',
  'skills.form.foreach': 'ForEach',
  'skills.form.conditionHint': 'Sub-steps must be edited in YAML',
  'skills.history.title': 'History',
  'skills.history.empty': 'No execution history',
  'skills.history.back': 'Back',
  'skills.history.clear': 'Clear history',
  'skills.history.clearConfirm': 'Clear all execution history?',
