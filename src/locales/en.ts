...
const en: Record<TranslationKey, string> = {
  ...
  'createUser.grantPrivileges': 'Grant Privileges',
  ...
  'privileges.grantTitle': 'Grant Privileges',
  ...
  'serverStatus.chartQps': 'Queries / sec',
  ...
  'sync.searchTables': 'Search tables…',
  'sync.filter.all': 'All',
  ...
  'sync.sqlPreviewTab': 'SQL preview',
  ...
  'sync.pageNext': 'Next',
  'sync.sqlPreviewTitle': 'SQL preview',
  ...
  'transfer.mode.structure': 'Structure only',
  'transfer.mode.data': 'Data only',
  ...
  'transfer.step.endpoints': 'Source / Target',
