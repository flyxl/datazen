...
const en: Record<TranslationKey, string> = {
  ...
  'sync.overwriteRetiredBanner': 'Overwrite copy (DROP + INSERT) has been retired. Data Synchronization compares rows and applies a change set; Apply is not wired yet.',
  'sync.applyUnavailable': 'Apply is unavailable until Diff Sync execute is ready',
