export type WindowKind = 'main' | 'new-connection' | 'connection' | 'settings' | 'data-sync' | 'schema-diff' | 'backup' | 'workflow' | 'docs' | 'dashboard';
...
export function getWindowKind(): WindowKind {
  ...
  else if (w === 'dashboard') cachedKind = 'dashboard';
