...
export function StructureColumnTable({
  ...
  const dataTypeListId = `structure-column-types-${mode}`;
      ...
      <table className="w-full border-collapse text-[13px]">
        <thead className="sticky top-0 z-10">
          <tr className="bg-surface-alt text-left text-xs font-medium text-fg-secondary">
            ...
            <th className="min-w-[140px] border-b border-edge px-2 py-2.5 font-medium">
              {t('structView.fieldName')}
            </th>
            <th className="min-w-[160px] border-b border-edge px-2 py-2.5 font-medium">
              {t('structView.type')}
            </th>
            <th className="w-[60px] border-b border-edge px-2 py-2.5 text-center font-medium">
            ...
            <th className="min-w-[120px] border-b border-edge px-2 py-2.5 font-medium">
              ...
              >
                ...
                <td className="px-2 py-1.5">
                  <Input
                    ...
                    disabled={!canRename}
                    title={
                      !canRename ? disabledTitle(isNew ? 'addColumn' : 'renameColumn') : undefined
                    }
                ...
                <td className="px-2 py-1.5">
                  <Input
                    ...
                    title={
                      !canAlterType ? disabledTitle(isNew ? 'addColumn' : 'alterType') : undefined
                    }
                    onChange={(e) => onUpdate(col.id, { dataType: e.target.value })}
                    placeholder={uiConfig.defaultColumnType}
                ...
                <td className="px-2 py-1.5 text-center">
                  <input
                    ...
                    title={
                      !canAlterNull
                        ? disabledTitle(isNew ? 'addColumn' : 'alterNullability')
                        : undefined
                    }
                ...
                <td className="px-2 py-1.5">
                  <Input
                    ...
                    title={
                      !canAlterDefault
                        ? disabledTitle(isNew ? 'addColumn' : 'alterDefault')
                        : undefined
                    }
                ...
                <td className="px-1 py-1.5 text-center">
                  <button
                    ...
                    title={
                      !canDrop && !isNew
                        ? disabledTitle('dropColumn')
                        : t('structEditor.deleteColumn')
                    }
