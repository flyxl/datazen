...
export function SchemaDiffEndpointsBar({
  ...
  return (
    <div className="flex shrink-0 items-center gap-3 border-b border-edge px-6 py-4">
      <div className="min-w-0 flex-1" data-testid="schema-diff-source">
        ...
        />
        <div data-testid="schema-diff-source-database" className="mt-2">
          <Select
        ...
        {showSourceSchema && (
          <div data-testid="schema-diff-source-schema" className="mt-2">
      ...
      <div className="min-w-0 flex-1" data-testid="schema-diff-target">
        <label className="mb-1 block text-[11px] font-semibold uppercase tracking-wider text-fg-muted">
          {t('sync.target')}
        </label>
        <Select
        ...
        />
        <div data-testid="schema-diff-target-database" className="mt-2">
          <Select
        ...
        {showTargetSchema && (
          <div data-testid="schema-diff-target-schema" className="mt-2">
            <label className="mb-1 block text-[10px] font-medium uppercase tracking-wider text-fg-muted">
              {t('sync.schema')}
            </label>
            <Select
